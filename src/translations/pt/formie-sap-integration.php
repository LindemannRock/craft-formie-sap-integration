...
return [
    ...
    'Enter a custom OAuth redirect URI if needed. Leave empty to use Craft\'s default.' => 'Introduza um URI de redirecionamento OAuth personalizado, se necessário. Deixe em branco para utilizar o valor predefinido do Craft.',
    ...
    'Select the field that contains the email address.' => 'Selecione o campo que contém o endereço de e-mail.',
    'Select the field that contains the invoice ID.' => 'Selecione o campo que contém o ID de fatura.',
    'Select the field that contains the member ID.' => 'Selecione o campo que contém o ID de membro.',
    'Select the field that contains the mobile number.' => 'Selecione o campo que contém o número de telemóvel.',
    'Select which form fields should be mapped to the header fields (memberID, memberMobile, memberEmail, invoiceID) in the SAP payload.' => 'Selecione quais os campos do formulário que devem ser mapeados para os campos de cabeçalho (memberID, memberMobile, memberEmail, invoiceID) no payload SAP.',
];
