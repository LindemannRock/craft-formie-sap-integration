...
If you discover a security vulnerability in Formie SAP Integration, please report it privately. **Do not open a public GitHub issue** — public disclosure before a fix is available puts other users at risk.

### Preferred: GitHub private advisory

[Open a private security advisory](https://github.com/LindemannRock/craft-formie-sap-integration/security/advisories/new). This routes the report directly to maintainers with no public visibility.
...
- SAP credential exposure or integration auth bypass
- Submission data leakage to unintended SAP endpoints
